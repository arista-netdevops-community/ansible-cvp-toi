...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.0.13/24 | 10.255.0.1 |
...
| Port-Channel5 | DC1_L2LEAF1_Po1 | 1500 | switched | trunk | 110-112,120-121,130-131 | - | 5 | - | - |
...
| Ethernet5 | DC1-L2LEAF1A_Ethernet1 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 5 | active |
...
| Vlan112 | Tenant_A_OP_Zone_3 | Tenant_A_OP_Zone  | 10.1.12.1/24 | True | - | - |
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WEB_Zone | Tenant_A_WEB_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3011 | MLAG_PEER_L3_iBGP: vrf Tenant_A_APP_Zone | Tenant_A_APP_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3012 | MLAG_PEER_L3_iBGP: vrf Tenant_A_DB_Zone | Tenant_A_DB_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3013 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WAN_Zone | Tenant_A_WAN_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3019 | MLAG_PEER_L3_iBGP: vrf Tenant_B_OP_Zone | Tenant_B_OP_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3020 | MLAG_PEER_L3_iBGP: vrf Tenant_B_WAN_Zone | Tenant_B_WAN_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3029 | MLAG_PEER_L3_iBGP: vrf Tenant_C_OP_Zone | Tenant_C_OP_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_WAN_Zone | Tenant_C_WAN_Zone  | 10.255.254.0/31 | - | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table  | 10.255.254.0/31 | - | - | - |
...
| 20 | permit 10.255.254.0/24 le 31 |
...
ip prefix-list PL-P2P-UNDERLAY
   ...
   seq 20 permit 10.255.254.0/24 le 31
!
```
...
| Tenant_A_DB_Zone | 192.168.255.3:13 | both 13:13 | learned | 140-141 |
| Tenant_A_NFS | 192.168.255.3:10161 | both 10161:10161 | learned | 161 |
| Tenant_A_OP_Zone | 192.168.255.3:10 | both 10:10 | learned | 110-112 |
| Tenant_A_VMOTION | 192.168.255.3:55160 | both 55160:55160 | learned | 160 |
| Tenant_A_WAN_Zone | 192.168.255.3:14 | both 14:14 | learned | 150 |
...
| Tenant_B_WAN_Zone | 192.168.255.3:21 | both 21:21 | learned | 250 |
| Tenant_C_OP_Zone | 192.168.255.3:30 | both 30:30 | learned | 310-311 |
| Tenant_C_WAN_Zone | 192.168.255.3:31 | both 31:31 | learned | 350 |
...
| Tenant_A_DB_Zone | 192.168.255.3:13 | import 13:13<br> export 13:13 | connected |
| Tenant_A_OP_Zone | 192.168.255.3:10 | import 10:10<br> export 10:10 | connected |
| Tenant_A_WAN_Zone | 192.168.255.3:14 | import 14:14<br> export 14:14 | connected |
...
| Tenant_B_WAN_Zone | 192.168.255.3:21 | import 21:21<br> export 21:21 | connected |
| Tenant_C_OP_Zone | 192.168.255.3:30 | import 30:30<br> export 30:30 | connected |
| Tenant_C_WAN_Zone | 192.168.255.3:31 | import 31:31<br> export 31:31 | connected |
