...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.0.15/24 | 10.255.0.1 |
...
| Port-Channel5 | DC1_L2LEAF2_Po1 | 1500 | switched | trunk | 110-112,120-121,130-131 | - | 5 | - | - |
...
| Ethernet5 | DC1-L2LEAF2A_Ethernet1 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 5 | active |
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WEB_Zone | Tenant_A_WEB_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3011 | MLAG_PEER_L3_iBGP: vrf Tenant_A_APP_Zone | Tenant_A_APP_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3012 | MLAG_PEER_L3_iBGP: vrf Tenant_A_DB_Zone | Tenant_A_DB_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3013 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WAN_Zone | Tenant_A_WAN_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3019 | MLAG_PEER_L3_iBGP: vrf Tenant_B_OP_Zone | Tenant_B_OP_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3020 | MLAG_PEER_L3_iBGP: vrf Tenant_B_WAN_Zone | Tenant_B_WAN_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3029 | MLAG_PEER_L3_iBGP: vrf Tenant_C_OP_Zone | Tenant_C_OP_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_WAN_Zone | Tenant_C_WAN_Zone  | 10.255.254.4/31 | - | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table  | 10.255.254.4/31 | - | - | - |
...
| Tenant_A_OP_Zone | 192.168.255.5:10 | both 10:10 | learned | 110-112 |
| Tenant_A_VMOTION | 192.168.255.5:55160 | both 55160:55160 | learned | 160 |
| Tenant_A_WAN_Zone | 192.168.255.5:14 | both 14:14 | learned | 150 |
...
| Tenant_B_WAN_Zone | 192.168.255.5:21 | both 21:21 | learned | 250 |
| Tenant_C_OP_Zone | 192.168.255.5:30 | both 30:30 | learned | 310-311 |
| Tenant_C_WAN_Zone | 192.168.255.5:31 | both 31:31 | learned | 350 |
...
| Tenant_A_WAN_Zone | 192.168.255.5:14 | import 14:14<br> export 14:14 | connected |
...
| Tenant_B_WAN_Zone | 192.168.255.5:21 | import 21:21<br> export 21:21 | connected |
| Tenant_C_OP_Zone | 192.168.255.5:30 | import 30:30<br> export 30:30 | connected |
| Tenant_C_WAN_Zone | 192.168.255.5:31 | import 31:31<br> export 31:31 | connected |
